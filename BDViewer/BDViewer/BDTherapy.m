...
{
    NSArray *entities = [[DataController sharedInstance] retrieveManagedObjectsForValue:ENTITYNAME_THERAPY withKey:@"therapyGroupId" withValue:theUUID orderedBy:@"displayOrder" withMOC:nil];
    return entities;
}
