...
{
    NSArray *entities = [[DataController sharedInstance] retrieveManagedObjectsForValue:ENTITYNAME_PATHOGEN withKey:@"pathogenGroupId" withValue:theUUID orderedBy:@"displayOrder" withMOC:nil];
    return entities;
}
